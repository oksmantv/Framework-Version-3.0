...
if ((side _unit) isEqualTo "CIV") then {
	...
	if (_stealthEnabled) then {
		...
		_unit setSkill ["spotDistance", ((_unit skill "spotDistance") min 0.25)];
		_unit setSkill ["spotTime", ((_unit skill "spotTime") min 0.35)];
		_unit setSkill ["commanding", ((_unit skill "commanding") min 0.35)];
