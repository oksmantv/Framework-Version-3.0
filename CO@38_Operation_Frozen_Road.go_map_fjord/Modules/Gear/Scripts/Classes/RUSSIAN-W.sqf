...
_insignia = "";
_goggles = ["rhsusf_shemagh_white","rhsusf_shemagh2_white"];
_helmet = ["UK3CB_CSAT_S_O_H_6b47_bala_WIN","UK3CB_CSAT_S_O_H_6b47_ess_bala_WIN","UK3CB_CSAT_S_O_H_6b47_ess_WIN"];
_OfficerHelmet = "UK3CB_CSAT_S_O_H_6b47_bala_WIN";
_uniform = ["UK3CB_CHD_W_B_U_CombatSmock_19","UK3CB_U_KZS_UP_WIN","UK3CB_U_KZS_UP_GHILLIE_WIN","UK3CB_U_KZS_DOWN_GHILLIE_WIN","UK3CB_U_KZS_DOWN_WIN","UK3CB_CSAT_S_O_U_SF_CombatSmock_03_WIN"];
_vest = ["UK3CB_CSAT_S_O_V_TacVest"];
_backpack = "UK3CB_CSAT_S_O_B_UMBTS";
_backpackRadio = _backpack;

if (true) then {
	_backpackRadio = "UK3CB_CSAT_S_O_B_UMBTS_RADIO";
};
