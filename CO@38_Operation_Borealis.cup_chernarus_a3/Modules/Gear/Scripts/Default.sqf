...
switch (toLower(_role)) do {
	...
	case "sl": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[["ACE_DAGR",1],[_mapTools,1],[_HelmetCam,1],[_notepad,1],[_cables,6],[_gps,1],[_grenade,2],[_flashBang,2],[_pistol_mag,2],[_glsmokeR,5],[_smokegrenadeY,4],[_smokegrenadeB,3]] call _addToUniform;
		[[_grenade,2],[_rifleGL_mag_tr,5],[_glHEDP,7]] call _addToVest;
		[[_rifleGL_mag,4]] call _addToBackpack;
		_rangefinder call _addBino;
		[_map, "", "", _compass, _watch, ""] call _addLinkedItems;
	...
	case "ftl": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[["ACE_DAGR",1],[_notepad,1],[_HelmetCam,1],[_cables,6],[_gps,1],[_flashBang,3],[_smokegrenadeB,3]] call _addToUniform;
