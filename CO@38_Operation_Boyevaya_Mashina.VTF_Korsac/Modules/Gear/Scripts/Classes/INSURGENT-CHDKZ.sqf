...
_LAT = ["GOL_weap_RPG17_Type59", _silencer, _pointer, _sight, _bipod];
_LAT_mag = "GOL_mag_rpg17_Type59";
_LAT_ReUsable = false;

_MAT = ["GOL_weap_RPG7_RHS", _silencer, _pointer, _sight, _bipod];
_MAT_mag = "GOL_mag_rpg7_Type59";
_MAT_mag_HE = "GOL_mag_rpg7_Type59";

_HAT = ["GOL_weap_RPG7_RHS", _silencer, _pointer, _sight, _bipod];
_HAT_mag = "GOL_mag_rpg7_Type59";
