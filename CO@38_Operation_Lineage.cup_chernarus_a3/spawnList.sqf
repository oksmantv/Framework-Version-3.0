...
switch (_case) do {
	...
	case 9: {
		...
		{
			[east, _X, [2247.48,2417.16,0], 7, 300, 30] spawn OKS_fnc_ArtyFire; sleep 3;
	...
	case 16: {
		...
		[convoy_10, convoy_11, convoy_12, east, [5, ["rhs_bmp1_msv","rhs_bmp1_msv","UK3CB_CHD_O_Pickup","UK3CB_CHD_O_Pickup","UK3CB_CHD_O_T55"], 35, 45], [true, 6], [], false, false, ["hunt"]] spawn OKS_fnc_Convoy_Spawn; sleep 10;
		sleep 15;
