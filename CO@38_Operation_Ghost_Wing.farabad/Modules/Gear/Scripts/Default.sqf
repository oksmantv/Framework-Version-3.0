...
switch (toLower(_role)) do {
	...
	case "sl": {
		...
		_IFAK call _addToUniform;
		[[_mapTools,1],["acex_intelitems_notepad",1],[_cables,6],[_gps,1],[_grenade,2],[_flashBang,2],[_pistol_mag,2]] call _addToUniform;
		[["10Rnd_50BW_Mag_F",5],[_grenade,2],[_rifleGL_mag_tr,5],[_glHEDP,7],[_glsmokeR,5],[_smokegrenadeY,4],[_smokegrenadeB,3]] call _addToVest;
		[[_rifleGL_mag,4]] call _addToBackpack;
		_rangefinder call _addBino;
		[_map, "", "", _compass, _watch, ""] call _addLinkedItems;
	...
	case "sm": {
		...
		[["10Rnd_50BW_Mag_F",5],[_smokegrenadeB,3],[_grenade,2],[_rifleC_mag_tr,6]] call _addToVest;
	...
	case "ftl": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[["10Rnd_50BW_Mag_F",5],["acex_intelitems_notepad",1],[_cables,6],[_gps,1],[_flashBang,3],[_smokegrenadeB,3]] call _addToUniform;
	...
	case "r": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[["10Rnd_50BW_Mag_F",5],[_cables,4],[_defusalKit,1],[_flashBang,3],[_pistol_mag,2],[_smokegrenadeY,3]] call _addToUniform;
	...
	case "g": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[["10Rnd_50BW_Mag_F",5],[_cables,6],[_grenade,2],[_flashBang,3],[_pistol_mag,2],[_smokegrenadeY,3]] call _addToUniform;
	...
	case "ag": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[["10Rnd_50BW_Mag_F",5],[_cables,6],[_rifle_mag,2],[_pistol_mag,2],[_smokegrenadeY,4],[_grenade,2],[_flashBang,2]] call _addToUniform;
	...
	case "mat": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[["10Rnd_50BW_Mag_F",5],[_flashBang,3],[_cables,6],[_pistol_mag,2],[_smokegrenadeY,3]] call _addToUniform;
	...
	case "amat": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[["10Rnd_50BW_Mag_F",5],[_flashBang,3],[_cables,6],[_grenade,4],[_pistol_mag,2],[_smokegrenadeY,3]] call _addToUniform;
	...
	case "ammg": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[["10Rnd_50BW_Mag_F",5],[_flashBang,3],[_cables,6],[_smokegrenadeY,4],[_grenade,2]] call _addToUniform;
