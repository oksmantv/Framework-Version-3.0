...
if(isServer) then {
	...
	[Group hostage_1, getMarkerPos "respawn_west", west, false, nil, true, true] spawn OKS_fnc_Evacuate_HVT;
	[Group hostage_2, getMarkerPos "respawn_west", west, false, nil, true, true] spawn OKS_fnc_Evacuate_HVT;
	[Group hostage_3, getMarkerPos "respawn_west", west, false, nil, true, true] spawn OKS_fnc_Evacuate_HVT;
	[Group hostage_4, getMarkerPos "respawn_west", west, false, nil, true, true] spawn OKS_fnc_Evacuate_HVT;
	[Group hostage_5, getMarkerPos "respawn_west", west, false, nil, true, true] spawn OKS_fnc_Evacuate_HVT;
	[Group hostage_6, getMarkerPos "respawn_west", west, false, nil, true, true] spawn OKS_fnc_Evacuate_HVT;
	[Group hvt_1, 	  getMarkerPos "respawn_west", west, false, nil, false, true] spawn OKS_fnc_Evacuate_HVT;
