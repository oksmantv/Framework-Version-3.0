...
_insignia = "";
_goggles = "";
_helmet = ["rhs_altyn_novisor","rhs_altyn","rhs_altyn_visordown"];
_OfficerHelmet = "rhs_pilotka";
_uniform = "rhs_uniform_gorka_1_b";
_vest = ["rhs_6b5_spetsodezhda","rhs_6b5_sniper_khaki","rhs_6b5_medic_khaki"];
_backpack = "UK3CB_UN_B_B_RIF";
