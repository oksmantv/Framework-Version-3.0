...
_insignia = "";
_goggles = "G_Armband_tak3_alt_F";
_helmet = ["UK3CB_TKA_O_H_6b27m_ESS_Surpat","UK3CB_TKA_O_H_6b27m_Surpat"];
_OfficerHelmet = "rhs_6b7_1m_ess";
_uniform = "rhs_uniform_vdv_emr_des";
_vest = ["UK3CB_TKA_O_V_6b23_ml_6sh92_vog_Surpat"];
_backpack =["UK3CB_B_Alice_Bedroll_2_K","UK3CB_B_Alice_Bedroll_K"];
