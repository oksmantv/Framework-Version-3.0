...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
		...
		if(isServer && GOL_NEKY_HUNT isEqualTo 1) then {
			...
			[Base_2, Spawn_2, NEKY_Hunt_Trigger_3, 6,300,east,4,60] spawn NEKY_Hunt_HuntBase;
			[Base_3, Spawn_3, NEKY_Hunt_Trigger_3, 5,600,east,4,30] spawn NEKY_Hunt_HuntBase;
...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
			...
			if(isServer && GOL_OKS_AMBIENCE isEqualTo 1) then {
				...
				[west,"american"] spawn OKS_FaceSwap;
			};
		/*
		*/
