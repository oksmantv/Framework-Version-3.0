...
// General Settings
_TravelTime = 30;											// Time it takes for round to travel to its position. (Will always take a minimum of 2sec for sound effects sake).	Number (Seconds)
...
_PreciseReloadTime = 240;									// The time it takes for the mortar to prepare for another strike after performing a Precise strike.				Number (Seconds)
...
// Day/Night time
_Sunrise = 0.00;											// The time it gets bright enough for smokes to be used instead of flares.											Number (0.00 - 23.59)
