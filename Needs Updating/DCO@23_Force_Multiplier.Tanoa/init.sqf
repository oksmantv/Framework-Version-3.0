		...
		*/
		...
		if(isServer) then {
			...
			[
				...
				east, // Side of Enemy
				0, // Number of Infantry on Patrol
			...
			[
				...
				0, // Number of Tanks on Patrol
				[
					2,true,false,0 // 1. Number of Roadblocks 2. Should be on tarmac. 3. Should have dedicated patrol. 4. Chance for Static Vehicle (1 = 100%, 0.5 = 50%)
				],
				[
					0, // Motart
					false
				],[
					7, // Number of Random Objectives
					false // Should have dedicated patrols around it
				],
				[0,0,0,0,0] // Infantry, Wheeled, APCs, Tanks, Air Assault - Hunt Bases - Required Game Logic Location 'Respawn Point'	"
				,false
			...
			[
				...
				false, // DO NOT EDIT
				[0,0,false,false], // 1. Number of Static Infantry 2. Number of Patrolling Infantry 3. Create Sector Objective on Garrison? 4. Should have dedicated patrols near static positions)
				east, // Side of Enemy
				6, // Number of Wheeled on Patrol
				2, // Number of APCs on Patrol
				1, // Number of Tanks on Patrol
				[
					0,true,false,0.4 // 1. Number of Roadblocks 2. Should be on tarmac. 3. Should have dedicated patrol. 4. Chance for Static Vehicle (1 = 100%, 0.5 = 50%)
				],
				[
					0, // Motart
					false
				],[
					0, // Number of Random Objectives
					false // Should have dedicated patrols around it
				],
				[0,0,0,0,0] // Infantry, Wheeled, APCs, Tanks, Air Assault - Hunt Bases - Required Game Logic Location 'Respawn Point'	"
				,false
