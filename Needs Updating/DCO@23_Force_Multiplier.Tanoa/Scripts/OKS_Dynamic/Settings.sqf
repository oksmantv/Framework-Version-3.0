...
OPFOR FACTIONS:        CHEDAKI TKA DESERT_INSURGENTS RUSSIA_MODERN SOVIET TURKEY DESERT_MILITIA COMMUNIST_REBELS TANOA_REBEL
INDEPENDENT FACTIONS:  NAPA SYRIA

*/
Private _Faction = "TANOA_REBEL";
Switch (_Faction) do {
	...
	case "TANOA_REBEL":{
		// Tanoa Rebel Forces (TANOA_REBEL) - OPFOR
		_Wheeled = ["LOP_UA_UAZ_DshKM", "LOP_UA_UAZ_Open", "LOP_UA_UAZ", "LOP_UA_Ural", "LOP_UA_Ural_open", "UK3CB_CCM_O_Hilux_Pkm", "LOP_UVF_Landrover", "LOP_UVF_Offroad", "LOP_UVF_Offroad_M2","UK3CB_ARD_I_Hilux_Pkm", "UK3CB_ARD_I_Hilux_Open", "UK3CB_ARD_I_Hilux_Dshkm", "UK3CB_ARD_I_Hilux_Closed"];
		_APC = ["LOP_UA_BMP2", "UK3CB_KDF_I_BRDM2", "UK3CB_KDF_I_BTR40_MG", "UK3CB_ARD_I_Hilux_Zu23_Front","rhsgref_tla_g_btr60"];
		_Tank = ["LOP_AFR_T34","LOP_NK_T55"];
		_Artillery = ["UK3CB_KDF_O_2S1", "rhs_D30_msv", "rhs_D30_msv", "UK3CB_ARD_I_Hilux_Mortar"];
		_AntiAir = ["UK3CB_ARD_I_Hilux_Zu23", "UK3CB_CW_SOV_O_EARLY_Gaz66_ZU23", "UK3CB_CW_SOV_O_EARLY_Ural_Zu23", "UK3CB_KRG_O_ZU23"];
...
_ObjectiveTypes = ["cache","artillery","motorpool","antiair"];
