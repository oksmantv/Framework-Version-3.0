...
switch (toLower(_role)) do {
	...
	case "officer": {
		...
		[[_cables,2],[_gps,1],[_pistol_mag,2],[_smokegrenadeY,3],[_rifle_mag,3],[_chemR,5]] call _addToUniform;
	...
	case "pl": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,2],[_gps,1],[_pistol_mag,2],[_smokegrenadeY,3],[_chemR,5]] call _addToUniform;
	...
	case "fac": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,2],[_gps,1],[_pistol_mag,2],[_grenade,2],[_smokegrenadeY,6],[_chemR,5]] call _addToUniform;
	...
	case "sl": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,2],[_gps,1],[_grenade,2],[_flashBang,2],[_pistol_mag,2],[_chemR,5]] call _addToUniform;
		...
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
			[[_mapFlashLight,1],[_IRStrobe,1],[_handFlareW,8],[_handFlareG,4]] call _addToUniform;
	...
	case "sm": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,2],[_pistol_mag,2],[_smokegrenadeY,4],[_chemR,5]] call _addToUniform;
	...
	case "ftl": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,2],[_gps,1],[_smokegrenadeB,3],[_chemR,5]] call _addToUniform;
		...
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
			[[_mapFlashLight,1],[_IRStrobe,1]] call _addToUniform;
			[[_handFlareW,8],[_handFlareG,4],[_glFlareR,5],[_glFlareW,5]] call _addToBackpack;
		};
	};
	...
	case "r": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,4],[_defusalKit,1],[_pistol_mag,2],[_smokegrenadeY,3],[_chemR,5]] call _addToUniform;
		...
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
			[[_mapFlashLight,1],[_handFlareW,8],[_handFlareG,4]] call _addToUniform;
		};
	...
	case "g": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,2],[_grenade,2],[_pistol_mag,2],[_smokegrenadeY,3],[_chemR,5]] call _addToUniform;
		...
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
			[[_mapFlashLight,1],[_IRStrobe,1]] call _addToUniform;
			[[_handFlareW,8],[_handFlareG,4],[_glFlareW,5]] call _addToBackpack;
		};
		[[_MAT_mag,2]] call _addToBackpack;
	...
	case "ag": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,2],[_rifle_mag,2],[_pistol_mag,2],[_smokegrenadeY,4],[_chemR,5]] call _addToUniform;
	...
	case "ar": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,2],[_pistol_mag,2],[_smokegrenadeY,2],[_chemR,5]] call _addToUniform;
	...
	case "lr": {
		...
		[_LAT, _LAT_mag, ""] call _addLaunchers;
		[[_cables,4],[_rifleL_mag,4],[_pistol_mag,2],[_smokegrenadeY,3],[_chemR,5]] call _addToUniform;
	...
	case "mat": {
		...
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
			[[_mapFlashLight,1],[_handFlareW,8],[_handFlareG,4],[_handFlareR,1]] call _addToUniform;
		};
		if (_useMineDetector) then {
...
//		[[_mortarRangeCard,1]] call _addToUniform;
	...
	case "aa": {
		...
		[[_rifleC_mag,4],[_pistol_mag,2],[_smokegrenadeY,3]] call _addToUniform;
