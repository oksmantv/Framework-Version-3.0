...
_goggles = selectRandom ["rhsusf_shemagh_tan","rhsusf_shemagh2_tan"];
_helmet = selectRandom ["helmet_lwh_CCE_3","helmet_lwh_CCE_2","helmet_lwh_CCE"];
...
_LAT = ["rhs_weap_maaws", _silencer, _pointer, _sight, _bipod];
