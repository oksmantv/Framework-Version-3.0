...
_pointer = "rhsusf_acc_anpeq15_bk_top";
_sight = "optic_MRCO";
_bipod = "rhs_acc_grip_ffg2";

_rifle = ["hlc_rifle_416D10_st6", _silencer, _pointer, _sight, _bipod];
_rifleC = ["UK3CB_FAMAS_F1", _silencer, _pointer, _sight, _bipod];
_rifleGL = ["hlc_rifle_416D10_gl", _silencer, _pointer, _sight, _bipod];
_rifleL = ["hlc_rifle_416D20", _silencer, _pointer, _sight, "rhsusf_acc_harris_bipod"];
_rifle_mag = "hlc_30rnd_556x45_SPR_EMAG";
_rifle_mag_tr = "hlc_30rnd_556x45_t_EMAG";
_rifleC_mag = "UK3CB_FAMAS_25rnd_556x45_R";
_rifleC_mag_tr = "UK3CB_FAMAS_25rnd_556x45_RT";
_rifleGL_mag = "hlc_30rnd_556x45_SPR_EMAG";
_rifleGL_mag_tr = "hlc_30rnd_556x45_t_EMAG";
_rifleL_mag = "hlc_30rnd_556x45_SPR_EMAG";
