...
/* !! IGNORE AND DO NOT EDIT ALL OF THE ABOVE !! */
	...
	*/
	if(GOL_OKS_TASK isEqualTo 1) then {
		...
		[Laptop_1,1,GetPos Supply_1,west,nil] spawn OKS_TASKSETUP;
		[Laptop_2,1,GetPos Supply_2,west,nil] spawn OKS_TASKSETUP;
		[Laptop_3,1,GetPos Supply_3,west,nil] spawn OKS_TASKSETUP;
	};
...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
		...
		if(isServer && GOL_NEKY_AIRDROP isEqualTo 1) then {
			...
			[Base_1,Spawn_1, NEKY_Hunt_Trigger_1,east,"RHS_Mi8mt_vvsc","unload",[2,0.7]] spawn NEKY_Airbase;
			[Base_2,Spawn_2, NEKY_Hunt_Trigger_2,east,"RHS_Mi8mt_vvsc","unload",[2,0.7]] spawn NEKY_Airbase;
		};
