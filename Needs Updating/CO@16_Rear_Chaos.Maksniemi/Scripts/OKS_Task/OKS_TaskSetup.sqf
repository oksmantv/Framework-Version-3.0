...
switch (_TaskNumber) do {
	...
	case 1:{
		_TaskID = "OKS_TASK_1";
		_TaskTitle = "Intel: Resupply";
		_TaskDescription = "Intel found suggests an ammo cache in the area. You may use it's contents for yourself.";
		_TaskAction = "Read Intel";
		_TaskMarkerText = "Resupply";
		_TaskType = "container";
