...
OKS_Enemy_Speak = {
	...
	if(_Dice < _Chance) then {
		...
		_SoundFileName = selectRandom ["Radio1","Radio2","Radio3","Radio4","Radio5","Radio6","Radio7","Radio8","Radio9","Radio10","Radio11","Radio12","Radio13","Radio14","Radio15","Radio16","Radio17","Radio18","Radio19","Radio20"];		SystemChat format["Selected SoundFile: %1.ogg",_SoundFileName];
