...
_pointer = selectRandom["rhs_acc_2dpzenit","","",""];
_sight = selectRandom["rhs_acc_1p29","rhs_acc_1p63","rhs_acc_1p78","rhs_acc_1pn93_1","rhs_acc_nita","rhs_acc_pgo7v","rhs_acc_pkas"];
_bipod = "";
...
_rifleL = ["rhs_weap_akmn", "rhs_acc_dtkakm", _pointer, _sight, _bipod];
