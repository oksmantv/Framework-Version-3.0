...
if(OKS_Difficulty isEqualTo 1) then {
	_Vehicles = [
		...
		"UK3CB_KDF_O_MTLB_Cannon", "UK3CB_CW_SOV_O_LATE_BMD1", "UK3CB_CW_SOV_O_LATE_BMD2", "UK3CB_CW_SOV_O_LATE_BTR80a"
	];		
...
switch (_case) do {
	...
	case 3: {
		...
		{if(!isPlayer _X) then {deleteVehicle _X}} foreach list Phase_1;
	...
	case 4: {
		...
		{if(!isPlayer _X) then {deleteVehicle _X}} foreach list Phase_2;
