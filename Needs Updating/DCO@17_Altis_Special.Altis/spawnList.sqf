...
switch (_case) do {
	...
	case 0:{
		...
		[spawner_1,east,1,30,55,10] execVM "Scripts\OKS_Spawn\OKS_SentrySpawner.sqf";
		[spawner_2,east,1,30,55,10] execVM "Scripts\OKS_Spawn\OKS_SentrySpawner.sqf";
		[spawner_3,east,1,30,55,10] execVM "Scripts\OKS_Spawn\OKS_SentrySpawner.sqf";
	...
	case 1: {
		...
		{[_x] remoteExec ["GW_SetDifficulty_fnc_setSkill",3]} foreach units _Group;
		[Beach_Trigger,0,EAST] spawn OKS_Populate_StaticWeapons;

		[aa_3,east,false,1500,true] execVM "Scripts\OKS_Spawn\GW_Ambient_AAA.sqf";
		[aa_4,east,false,1500,true] execVM "Scripts\OKS_Spawn\GW_Ambient_AAA.sqf";
		
	};

	case 2: {
		[aa_1,east,false,1500,true] execVM "Scripts\OKS_Spawn\GW_Ambient_AAA.sqf";
		[aa_2,east,false,1500,true] execVM "Scripts\OKS_Spawn\GW_Ambient_AAA.sqf";
		...
		[Trigger_4,false,[0,0,false,false],east,2,1,0,[4,true,false,1],[0,false],[2,false],[0,0,0,0,0],false] spawn OKS_CreateZone;
		[Trigger_1,false,[14,15,true,false],east,0,0,0,[0,true,false,0],[0,false],[1,false],[0,0,0,0,0],true] spawn OKS_CreateZone;
		[Trigger_2,false,[12,20,false,false],east,0,0,0,[0,true,false,0],[0,false],[1,false],[0,0,0,0,0],true] spawn OKS_CreateZone;
	};

	case 3: {
		[Trigger_3,false,[24,25,true,false],east,0,0,0,[0,true,false,0],[0,false],[1,false],[0,0,0,0,0]] spawn OKS_CreateZone;
	};

	case 4: {

		// Beach strike 1
		[arty_1,independent,[getPos target_13,getPos target_14,getPos target_15,getPos target_16],1,0,true] execVM "Scripts\OKS_Spawn\OKS_ArtySupression.sqf";
		[arty_2,independent,[getPos target_9,getPos target_10,getPos target_11,getPos target_12],1,0,true] execVM "Scripts\OKS_Spawn\OKS_ArtySupression.sqf"; 
		[arty_3,independent,[getPos target_1,getPos target_2,getPos target_3,getPos target_4],1,0,true] execVM "Scripts\OKS_Spawn\OKS_ArtySupression.sqf"; 
		[arty_4,independent,[getPos target_5,getPos target_6,getPos target_7,getPos target_8],1,0,true] execVM "Scripts\OKS_Spawn\OKS_ArtySupression.sqf"; 
	
		["HQ","side","Missile strike inbound on beach defences. Assault the beach, good luck!"] remoteExec ["OKS_Chat",0];
	};
	...
	case 5: {
		...
		if(((Alive nest_1) && !isNull (gunner nest_1) || (Alive nest_2) && !isNull (gunner nest_2))) then {
			...
			// Beach strike 2
			[arty_3,independent,[getPos zulu_1,getPos zulu_2],1,0,true] execVM "Scripts\OKS_Spawn\OKS_ArtySupression.sqf"; 
			[arty_4,independent,[getPos zulu_3,getPos zulu_4],1,0,true] execVM "Scripts\OKS_Spawn\OKS_ArtySupression.sqf"; 
			[arty_2,independent,[getPos zulu_5,getPos zulu_6],1,0,true] execVM "Scripts\OKS_Spawn\OKS_ArtySupression.sqf"; 
			[arty_1,independent,[getPos zulu_7,getPos zulu_8],1,0,true] execVM "Scripts\OKS_Spawn\OKS_ArtySupression.sqf";

			sleep 10;
			["HQ","side","Additional Missile strike inbound on Point Zulu. Take cover, take cover, take cover!"] remoteExec ["OKS_Chat",0];
		};
	};
	...
	case 6: {
		...
		// Point Bear Strike
		[arty_3,independent,[getPos bear_1,getPos bear_2,getPos bear_3],1,0,true] execVM "Scripts\OKS_Spawn\OKS_ArtySupression.sqf"; 
		[arty_4,independent,[getPos bear_4,getPos bear_5,getPos bear_6],1,0,true] execVM "Scripts\OKS_Spawn\OKS_ArtySupression.sqf"; 
		[arty_2,independent,[getPos bear_7,getPos bear_8,getPos bear_9],1,0,true] execVM "Scripts\OKS_Spawn\OKS_ArtySupression.sqf"; 
		[arty_1,independent,[getPos bear_10,getPos bear_11,getPos bear_12],1,0,true] execVM "Scripts\OKS_Spawn\OKS_ArtySupression.sqf";

		sleep 5; ["HQ","side","Additional Missile strike inbound on Point Bear. Once complete you may approach your next objective!"] remoteExec ["OKS_Chat",0];
	};
