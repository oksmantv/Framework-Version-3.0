...
_rifleC = ["hlc_rifle_aku12", _silencer, "rhs_acc_2dpzenit_ris", _sight, _bipod];
_rifleGL = ["rhs_weap_ak74mr_gp25", _silencer, "rhs_acc_2dpzenit_ris", _sight, _bipod];
...
_LMG = ["rhs_weap_m249_light_S", "ace_muzzle_mzls_l", "rhs_acc_2dpzenit_ris", _sight, "rhsusf_acc_kac_grip_saw_bipod"];
