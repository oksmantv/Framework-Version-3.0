...
"ASCZ_Nightstalkers" call bis_fnc_setppeffecttemplate;
...
Sleep 10;
if(isServer) then {
	[[officer_1,officer_2,officer_3,officer_4,officer_5,officer_6,officer_7,officer_8,officer_9,officer_10,officer_11,officer_12],Prisoner_Trigger,500, [player] call GW_Common_Fnc_getSide] execVM "Scripts\OKS_Ambience\OKS_HVT_MoraleHit_Intel.sqf";
};
"ASCZ_Nightstalkers" call bis_fnc_setppeffecttemplate;
