...
/*
	...
	[[artyStrike_1,artyStrike_2],"rhs_ammo_3of56",1,10,100,true,nil] spawn OKS_Fallback_Artillery;
	[[artyStrike_1,artyStrike_2],"rhs_ammo_3of56",1,10,100,true,"taskdefend"] spawn OKS_Fallback_Artillery;
	[[artyStrike_1,artyStrike_2],"rhs_ammo_3of56",1,10,100,true,"taskdefend"] execVM "Scripts\OKS_Task\OKS_Fallback_Artillery.sqf";
*/
...
_TaskIdArray = [];
_MarkerArray = [];
["hq","side","1st Platoon be advised, enemy artillery has zeroed in on your position! Check your map, we have intel that suggests this area will be struck! Get out of there! ETA 3 minutes!"] remoteExec ["OKS_Chat",0];

{
	...
	_TaskInfo = [true, _TaskArray, ["An enemy artillery strike is inbound, get out of the target area ASAP!", "Fallback: Artillery Strike", ""], _X,"AUTOASSIGNED",-1,true,"run"] call BIS_fnc_taskCreate;
	...
	_MarkerText setMarkerText "  Enemy Artillery Target";
