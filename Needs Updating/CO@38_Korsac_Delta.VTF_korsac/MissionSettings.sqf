...
GOL_ENTRENCH = 1;		  // Adds Entrenching Tools to certain roles.
...
GOL_ForceNVGClassname = "G_Armband_NVG_blu_alt_F"; // Forces the classname to be used as NVG.

/* AI Gear Settings */
// 0 = 0%, 1 = 100%
GOL_LAT_Chance = 0.15; // Chance for Light AT to be given to AI.
...
GOL_AIForceNVGClassname = "G_Armband_NVG_red_alt_F"; // Forces the AI classname to be used as NVG.
...
[] spawn {
	if(isServer && GOL_OKS_AMBIENCE isEqualTo 1) then {
		...
		[independent,"russian"] spawn OKS_FaceSwap;
	};
};
