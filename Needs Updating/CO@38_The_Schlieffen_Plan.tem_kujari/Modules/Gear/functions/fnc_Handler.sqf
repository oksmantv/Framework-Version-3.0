	...
	if !(_errorCode) then {
		switch (_class) do {
			...
			case "tiny_box": {		
				...
				[_Unit,"UK3CB_BAF_12G_Pellets",8] call _fnc_AddObjectsCargo;
			...
			case "small_box": {
				...
				[_Unit,"UK3CB_BAF_12G_Pellets",16] call _fnc_AddObjectsCargo;
				if (GVARMAIN(mod_ACE3)) then {
			...
			case "big_box": {
				...
				[_Unit,"UK3CB_BAF_12G_Pellets",24] call _fnc_AddObjectsCargo;
