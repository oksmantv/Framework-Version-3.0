...
switch (toLower(_role)) do {
	...
	case "ftl": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[["ACE_wirecutter",1],[_cables,2],[_gps,1],[_flashBang,3],[_smokegrenadeB,3]] call _addToUniform;
		[[_grenade,5],[_rifleGL_mag_tr,4],[_pistol_mag,2],[_smokegrenadeY,4]] call _addToVest;
	...
	case "r": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[["ACE_wirecutter",1],[_cables,4],[_defusalKit,1],[_flashBang,3],[_pistol_mag,2],[_smokegrenadeY,3]] call _addToUniform;
		[[_grenade,4],[_rifle_mag,4],[_rifle_mag_tr,4]] call _addToVest;
		...
		[[_MAT_mag,1],[_MAT_mag_HE,1]] call _addToBackpack;
		// if (_LAT_ReUsable) then {
		// 	[[_LAT_mag,1]] call _addToBackpack;
		// } else {
		// 	///((_loadout select 5) select 1) append ["UK3CB_BAF_L128A1",1]];
		// 	((_loadout select 5) select 1) append [[["UK3CB_BAF_L128A1","","","",[],[],""],1]];
		// };
	};
	...
	case "g": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[["ACE_wirecutter",1],[_cables,2],[_grenade,4],[_flashBang,3],[_pistol_mag,2],[_smokegrenadeY,3]] call _addToUniform;
		[[_grenade,2],[_rifleGL_mag,4],[_rifleGL_mag_tr,2],["UK3CB_BAF_12G_Pellets",8]] call _addToVest;
		[[_glHE,7],[_glsmokeR,3],[_glsmokeY,3],[_rifleGL_mag_tr,2]] call _addToBackpack;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
			[[_mapFlashLight,1],[_IRStrobe,1]] call _addToUniform;
	...
	case "ag": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[["ACE_wirecutter",1],[_cables,2],[_rifle_mag,2],[_pistol_mag,2],[_smokegrenadeY,4]] call _addToUniform;
		[[_rifle_mag,2],[_rifle_mag_tr,2],[_grenade,5],[_flashBang,2]] call _addToVest;
	...
	case "ar": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[["ACE_wirecutter",1],[_cables,2],[_pistol_mag,2],[_smokegrenadeY,2]] call _addToUniform;
		[[_flashBang,3],[_grenade,5],[_grenade,2]] call _addToVest;
	...
	case "lr": {
		...
		[[_grenade,2],[_grenade,4],[_rifleL_mag_tr,4]] call _addToVest;
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
	...
	case "ammg": {
		...
		[[_clacker,1],[_demoCharge,2],[_pistol_mag,2],[_rifle_mag_tr,6]] call _addToVest;
		(_FAKSmall + [[_MMG_mag,COUNT_AMMG_MAGS(_MMG_mag)]]) call _addToBackpack;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
