...
_pointer = "hlc_panel_side_scar_long_fn10cm_black";
_sight = "optic_erco_blk_f";
_bipod = "rhsusf_acc_harris_bipod";

_rifle = ["hlc_wp_SCARL_STD_SRX_Blk", _silencer, _pointer, _sight, _bipod];
_rifleC = ["hlc_wp_SCARL_CQC_Blk", _silencer, _pointer, _sight, _bipod];
_rifleGL = ["hlc_wp_SCARL_STD_EGLM_Blk", _silencer, _pointer, _sight, _bipod];
_rifleL = ["hlc_wp_SCARH_STD_SRX_Blk", _silencer, _pointer, _sight, _bipod];
...
_pistol = ["hgun_Pistol_heavy_01_F", _silencer, _pointer, _sight, _bipod];
