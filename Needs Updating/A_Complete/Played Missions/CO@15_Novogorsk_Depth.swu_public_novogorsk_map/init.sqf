...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
		...
		[RandomExplosionTrigger_1,40,"medium",true] execVM "Scripts\OKS_Ambience\OKS_Random_Explosion.sqf";
		[RandomExplosionTrigger_2,40,"heavy",true] execVM "Scripts\OKS_Ambience\OKS_Random_Explosion.sqf";
		[RandomExplosionTrigger_3,40,"heavy",true] execVM "Scripts\OKS_Ambience\OKS_Random_Explosion.sqf";
		[RandomExplosionTrigger_4,40,"medium",true] execVM "Scripts\OKS_Ambience\OKS_Random_Explosion.sqf";
		[RandomExplosionTrigger_5,40,"medium",true] execVM "Scripts\OKS_Ambience\OKS_Random_Explosion.sqf";
		[RandomExplosionTrigger_6,40,"medium",true] execVM "Scripts\OKS_Ambience\OKS_Random_Explosion.sqf";
		[RandomExplosionTrigger_7,40,"heavy",true] execVM "Scripts\OKS_Ambience\OKS_Random_Explosion.sqf";

		[units group hostage_1,getPos ExfilSite_1,west] execVM "Scripts\OKS_Task\OKS_Evacuate_HVT.sqf";
		[units group hostage_2,getPos ExfilSite_1,west] execVM "Scripts\OKS_Task\OKS_Evacuate_HVT.sqf";
		[units group hostage_3,getPos ExfilSite_1,west] execVM "Scripts\OKS_Task\OKS_Evacuate_HVT.sqf";
