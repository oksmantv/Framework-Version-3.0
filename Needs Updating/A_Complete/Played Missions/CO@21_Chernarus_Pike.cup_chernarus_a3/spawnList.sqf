...
switch (_case) do {
	...
	case 1: {
		...
		// Artillery Nest
		[east,mortar_1,getPos TargetObject,7,300,180] spawn OKS_ArtyFire; sleep 2;
		[east,mortar_2,getPos TargetObject,7,300,180] spawn OKS_ArtyFire;
	...
	case 2: {
		...
		[[[13410.8,11656.2,0],[13685.4,11588.9,0],[13749.9,11465.9,0]],2,1,10,"rush",east,1500,"trench1counter"] spawn OKS_Lambs_Wavespawn;
	...
	case 3: {
		...
		// Ambush
		[[[12958.4,11330,0],[12774.4,11556,0],[12753,11742.6,0],[13057,11844.4,0]],2,1,10,"rush",east,1500,"ambushcounter"] spawn OKS_Lambs_Wavespawn;
	...
	case 4: {
		// Trench 2 Counter
		[[[14015.2,11961.9,0],[13845.5,11959.3,0],[13635.7,11920.8,0]],3,1,10,"rush",east,1500,"trench2counter"] spawn OKS_Lambs_Wavespawn;
	...
	case 5: {
		// Evac Counter
		[[[14015.2,11961.9,0],[13845.5,11959.3,0],[13635.7,11920.8,0]],3,1,10,"rush",east,1500,"evaccounter"] spawn OKS_Lambs_Wavespawn;
	};

	case 6: {
		// Convoy Counter
		[[[13422.4,12457.4,0],[13330.6,12317.6,0],[13298.1,12230.4,0]],3,1,10,"rush",east,1500,"convoycounter"] spawn OKS_Lambs_Wavespawn;
	...
	case 8: {
		...
		// Evac 2 Counter
		[[[12022.9,13063.1,0],[12433.7,12979.2,0],[12685.6,12529.9,0],[12635.3,12835.9,0]],2,1,10,"rush",east,1500,"evaccounter2"] spawn OKS_Lambs_Wavespawn;
	...
	case 10:{
		...
		[[getPos evac_1,getPos evac_2,getPos evac_3,getPos evac_4],3,4,180,"rush",east,1500,"evacCounter"] spawn OKS_Lambs_Wavespawn;
	};
