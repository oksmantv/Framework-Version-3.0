...
if(isServer && GOL_OKS_AMBIENCE isEqualTo 1) then {
	...
	[Group HVT_1,getPos ExfilSite_1,west,true] spawn OKS_Evacuate_HVT;
	[Group HVT_2,getPos ExfilSite_1,west,true] spawn OKS_Evacuate_HVT;
	[[officer_1,officer_2,officer_3],getPos ExfilSite_2,west,true,"",false] spawn OKS_Evacuate_HVT;
};