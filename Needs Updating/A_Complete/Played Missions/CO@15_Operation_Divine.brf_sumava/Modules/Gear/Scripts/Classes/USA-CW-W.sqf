...
_rifle = [["hlc_wp_m16A1","hlc_rifle_Colt727","hlc_wp_mod727"], _silencer, _pointer, _sight, _bipod];
_rifleC = ["hlc_wp_mod733", _silencer, _pointer, _sight, _bipod];
_rifleGL = [["hlc_rifle_A1m203","hlc_rifle_Colt727_GL"], _silencer, _pointer, _sight, _bipod];
