...
switch (_case) do {
	...
	case 0: {
		...
		// Convoy Ambush
		[convoy_1,convoy_2,convoy_3,east,[6,["UK3CB_CHD_O_T72BB","UK3CB_CHD_O_T72BB","UK3CB_CHD_O_BMP1","UK3CB_CHD_O_BMP1","UK3CB_CHD_O_MTLB_PKT","UK3CB_CHD_O_MTLB_PKT"], 6, 20],[true,6],ENEMY_CONVOY, false, false] spawn OKS_Convoy_Spawn;
		sleep 30;
