...
_helmet = ["rhsusf_ach_bare_wood","rhsusf_ach_bare_wood_ess","rhsusf_ach_bare_wood_headset","rhsusf_ach_bare_wood_headset_ess"];
...
_rifleL = ["JCA_arifle_M4A4_VFG_olive_F", _silencer, _pointer, _sight, _bipod];
...
_LMG = ["LMG_03_F", _silencer, _pointer, "JCA_optic_AHO_black", _bipod];
