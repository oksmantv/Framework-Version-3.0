...
_vest = ["rhsusf_spcs_ocp_teamleader","rhsusf_spcs_ocp_teamleader_alt","rhsusf_spcs_ocp_squadleader","rhsusf_spcs_ocp_saw","rhsusf_spcs_ocp_rifleman_alt","rhsusf_spcs_ocp_rifleman","rhsusf_spcs_ocp_grenadier"];
...
_rifleC = ["hlc_rifle_hk33a2RIS", _silencer, _pointer, _sight, _bipod];
