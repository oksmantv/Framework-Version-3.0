...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
		...
		if(isServer) then {
			...
			waitUntil{sleep 1; !(isNil "OKS_ArtyFire") && !isNil "GW_Ambient_AAA"};
			[west,arty_1,targetArty,20,300,60] spawn OKS_ArtyFire;
			[west,arty_2,targetArty,20,300,60] spawn OKS_ArtyFire;
			[west,arty_3,targetArty,5,300,40] spawn OKS_ArtyFire;
			[west,arty_4,targetArty,5,300,40] spawn OKS_ArtyFire;
			[west,arty_5,targetArty,5,300,40] spawn OKS_ArtyFire;
			...
			waitUntil{sleep 5; !(isNil "OKS_Helicopter_Patrol")};
			[west,"rhsgref_cdf_b_reg_Mi8amt",helipad_1,1000,[1,0.5],1000,getMarkerPos "helicopter_despawn",true,true] execVM "Scripts\NEKY_AirDrop\OKS_Helicopter_Patrol.sqf";
			[west,"rhsgref_cdf_b_reg_Mi8amt",helipad_2,1000,[1,0.5],1000,getMarkerPos "helicopter_despawn",true,true] execVM "Scripts\NEKY_AirDrop\OKS_Helicopter_Patrol.sqf";
			[west,"rhsgref_cdf_b_reg_Mi8amt",helipad_3,1000,[1,0.5],1000,getMarkerPos "helicopter_despawn",true,true] execVM "Scripts\NEKY_AirDrop\OKS_Helicopter_Patrol.sqf";		
			[officer_1] spawn OKS_Surrender;	
		};
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
		...
		if(isServer && GOL_NEKY_HUNT isEqualTo 1) then {
			...
			[Object_1, Spawn_1, HuntTrigger_1, 2,900,west,6,45] spawn NEKY_Hunt_HuntBase;
			[Object_2, Spawn_2, HuntTrigger_1, 2,900,west,6,45] spawn NEKY_Hunt_HuntBase;
			[Object_3, Spawn_3, HuntTrigger_1, 2,900,west,6,45] spawn NEKY_Hunt_HuntBase;
		};
