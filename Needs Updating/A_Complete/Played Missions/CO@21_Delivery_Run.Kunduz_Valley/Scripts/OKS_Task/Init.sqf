...
// Functions
OKS_CreateAreaMarkerOnTrigger = compile preprocessFileLineNumbers "Scripts\OKS_TASK\OKS_Deliver_Supplies\OKS_CreateAreaMarkerOnTrigger.sqf";
OKS_Defuse_Explosive = compile preprocessFileLineNumbers "Scripts\OKS_TASK\OKS_Defuse_Explosive.sqf";
OKS_Deliver_Supplies = compile preprocessFileLineNumbers "Scripts\OKS_TASK\OKS_Deliver_Supplies\OKS_Deliver_Supplies.sqf";
...
OKS_Request_Intel = compile preprocessFileLineNumbers "Scripts\OKS_TASK\OKS_Request_Intel\OKS_Request_Intel.sqf";
