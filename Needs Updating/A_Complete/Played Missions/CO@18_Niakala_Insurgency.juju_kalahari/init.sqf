...
Briefing_script = compile preprocessFileLineNumbers "briefing.sqf";
[intel_1, "hostage1.jpg"] remoteExec ["ace_intelitems_fnc_setObjectData",0];

if(isServer) then {
	IDAP_ATTACK_ARRAY = [];
	publicVariable "IDAP_ATTACK_ARRAY";
};
