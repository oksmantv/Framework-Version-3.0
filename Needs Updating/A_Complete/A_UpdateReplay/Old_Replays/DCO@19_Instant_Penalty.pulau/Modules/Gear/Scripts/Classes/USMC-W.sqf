...
_goggles = "UK3CB_G_Balaclava";
_helmet = selectRandom ["rhsusf_opscore_fg_pelt_cam"];
...
_rifleGL = ["rhs_weap_m4a1_blockII_M203_bk", _silencer, _pointer, _sight, "rhsusf_acc_grip_m203_blk"];
