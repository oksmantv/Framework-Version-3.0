	...
	[] execVM "Scripts\OKS_Dynamic\Init.sqf";
		...
		*/
		...
		/* Example of Dynamic Scripts */
			if(isServer) then {
				[Trigger_1,false,[20,20,true],east,1,1,0,[0,true],0,1,[0,0,0,0,0]] spawn OKS_CreateZone; sleep 120;
				[Trigger_2,false,[15,20,true],east,0,3,0,[0,true],0,2,[0,0,0,0,0]] spawn OKS_CreateZone;
			};
