...
/* !! IGNORE AND DO NOT EDIT ALL OF THE ABOVE !! */
	...
	*/
	if(GOL_OKS_TASK isEqualTo 1) then {
		...
		[10,2,getPos house_1,east,true,["lot","large"]] spawn OKS_Rescue_Friendly;
		[10,2,getPos house_2,east,true,["lot","large"]] spawn OKS_Rescue_Friendly;
		[10,2,getPos house_3,east,true,["lot","large","fatal"]] spawn OKS_Rescue_Friendly;
		[8,getPos escort_1,east,true,getpos exfil_1] spawn OKS_Escort_Friendly;
		[8,getPos escort_2,east,true,getpos exfil_2] spawn OKS_Escort_Friendly;
		[8,getPos escort_3,east,true,getpos exfil_3] spawn OKS_Escort_Friendly;
		[[barricade_1,barricade_2]] spawn OKS_Destroy_Barricade;
		[[barricade_3,barricade_4]] spawn OKS_Destroy_Barricade;
		[8,getPos escort_5,east,true,getpos exfil_5] spawn OKS_Escort_Friendly;
		[8,getPos escort_4,east,true,getpos exfil_4] spawn OKS_Escort_Friendly;
		[8,getPos escort_6,east,true,getpos exfil_6] spawn OKS_Escort_Friendly;
	};
...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
		...
		if(isServer) then {
			...
			[Trigger_1,false,[15,15,false,true],west,0,0,0,[1,true,false,0],[0,false],[2,false],[0,0,0,0,0],false] spawn OKS_CreateZone;
		};
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
		...
		if(isServer && GOL_NEKY_HUNT isEqualTo 1) then {
			...
			Private _Vehicles = ["I_APC_tracked_03_cannon_F", "I_LT_01_cannon_F", "LOP_AFR_T55", "LOP_UKR_BMP2"];
			[Base_3, Spawn_3, NEKY_Hunt_Trigger_1, 5,900,west,_Vehicles,120] spawn NEKY_Hunt_HuntBase;
			[Base_4, Spawn_4, NEKY_Hunt_Trigger_1, 5,900,west,_Vehicles,120] spawn NEKY_Hunt_HuntBase;
			[Base_5, Spawn_5, NEKY_Hunt_Trigger_2, 5,900,west,_Vehicles,120] spawn NEKY_Hunt_HuntBase;
			[Base_6, Spawn_6, NEKY_Hunt_Trigger_2, 5,900,west,_Vehicles,120] spawn NEKY_Hunt_HuntBase;
		};
...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
			...
			if(isServer && GOL_OKS_AMBIENCE isEqualTo 1) then {
				...
				[west,"middleeast"] spawn OKS_FaceSwap;
			};
		/*
		*/
		[aa_1,west,3,false,500] execVM "Scripts\OKS_Ambience\GW_Ambient_AAA.sqf";
		[aa_2,west,3,false,500] execVM "Scripts\OKS_Ambience\GW_Ambient_AAA.sqf";
		[aa_3,west,3,false,500] execVM "Scripts\OKS_Ambience\GW_Ambient_AAA.sqf";
		[aa_4,west,3,false,500] execVM "Scripts\OKS_Ambience\GW_Ambient_AAA.sqf";
