...
null=[unit_source,life_time,kill_time] execVM "AL_fire\al_unit_fire.sqf";
/*
...
null=[source,diameter,life_time,damage_inflicted,spreading_diameter,craters,hide_destr_veg,building_damage] execVM "AL_fire\al_wild_fire.sqf";
...
null=[this,200,860,-1,true,false,0.5] execVM "AL_fire\al_wild_fire.sqf";

///////////// Setting an area on fire from another script executed in global space
null=[wildfire_1,200,860,-1,true,false,0.5] execVM "AL_fire\al_wild_fire.sqf";
...
null=[fire_source,fire_pressure,life_time,inflict_damage,kill_source_end] execVM "AL_fire\al_small_fire.sqf";
...
null=[car_3,3,30,false,true] execVM "AL_fire\al_small_fire.sqf";

///////////// Create a fire place using its init field
null=[this,3,30,true,true] execVM "AL_fire\al_small_fire.sqf";
...
null=[vehicle_source,life_time,destroy_vehicle,crew_fire] execVM "AL_fire\al_vehicle_fire.sqf";
...
null=[this,30,true,true] execVM "AL_fire\al_vehicle_fire.sqf";

///////////// Set vehicle on fire in another script executed in global space
null=[car_x,60,true,true] execVM "AL_fire\al_vehicle_fire.sqf";
...
null=[fire_source,life_time,diameter,flame_size,damage_on_buildings,smoke_on,brightness] execVM "AL_fire\al_fire_deco.sqf";
...
null=[this,600,10,5,0.5,true,0.5] execVM "AL_fire\al_fire_deco.sqf";

///////////// Create fire via another script executed in global space
null=[roof,600,5,3,0.5,true,0.5] execVM "AL_fire\al_fire_deco.sqf";