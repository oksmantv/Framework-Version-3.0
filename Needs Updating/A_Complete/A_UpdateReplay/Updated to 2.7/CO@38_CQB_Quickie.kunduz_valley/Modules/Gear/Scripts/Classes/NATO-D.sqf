...
_helmet = ["H_HelmetSpecB_snakeskin"];
...
_rifle_mag_tr = "ACE_30Rnd_65x39_caseless_mag_Tracer_Dim";
_rifleGL_mag = "30Rnd_65x39_caseless_mag";
_rifleGL_mag_tr = "ACE_30Rnd_65x39_caseless_mag_Tracer_Dim";
_rifleL_mag = "30Rnd_65x39_caseless_mag";
_rifleL_mag_tr = "ACE_30Rnd_65x39_caseless_mag_Tracer_Dim";

_LMG = ["arifle_MX_SW_F", _silencer, _pointer, _sight, _bipod];
_LMG_mag = "100Rnd_65x39_caseless_mag_Tracer";

_MMG = ["MMG_02_camo_F", _silencer, _pointer, _sight, _bipod];
