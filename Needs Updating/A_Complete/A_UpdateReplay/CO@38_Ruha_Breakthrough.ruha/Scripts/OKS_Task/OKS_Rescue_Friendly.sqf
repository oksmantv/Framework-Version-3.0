	...
	Parameters:
	1 - Integer - Amount of Friendly Units
	2 - Integer - Number of Friendly Casualties
	3 - Position - Position of said Friendly Group (Will seek nearest house)
	4 - Bool - Should create task when activated
	5 - Array (string) - Type of casualty types generated
		Options: easy, medium, heavy, lot, large, fatal 

	Examples:
	[6,2,getPos house1,west,true,["lot","large","fatal"]] spawn OKS_Rescue_Friendly;
	[5,1,getPos player,east,true,["lot","large","fatal"]] spawn OKS_Rescue_Friendly;
