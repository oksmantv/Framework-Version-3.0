...
_insignia = "";
_goggles = ["UK3CB_G_Balaclava2_MEE","UK3CB_G_Balaclava_Neck_Shemag_MEE","UK3CB_G_Balaclava2_BLK","UK3CB_G_Balaclava2_MEE"];
_helmet = ["UK3CB_TKM_I_H_Turban_03_1","","UK3CB_TKM_I_H_Turban_04_1","UK3CB_TKM_I_H_Turban_05_1","UK3CB_TKM_I_H_Turban_01_1","UK3CB_TKM_I_H_Turban_02_1"];
...
if(_role == "officer") then {
	_uniform = ["UK3CB_TKP_I_U_CombatUniform_BLK","UK3CB_TKP_I_U_QRF_CombatUniform_BLK","UK3CB_TKP_O_U_CombatUniform_Blk","UK3CB_TKP_O_U_Officer_Blk"];
	_vest = ["UK3CB_TKP_O_V_6b23_ML_6sh92_radio_BLK"];
	_backpack = "tfw_ilbe_dd_gr";
	_backpackRadio = "tfw_ilbe_dd_gr";
	_headgear = ["UK3CB_TKP_I_H_Beret","UK3CB_TKP_O_H_Beret","UK3CB_TKP_B_H_Beret"];
	_goggles = ["rhs_facewear_6m2_1","G_Aviator","G_Squares_Tinted","rhs_googles_black","G_Bandanna_CandySkull","G_Bandanna_Skull1"];
};
