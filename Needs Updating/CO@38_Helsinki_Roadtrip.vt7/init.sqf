...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
		...
		// ARTY
		[east,arty_1,getMarkerPos "target",7,300,150] spawn OKS_ArtyFire;
		[east,arty_2,getMarkerPos "target",7,300,150] spawn OKS_ArtyFire;
		[east,arty_3,getMarkerPos "target",7,300,150] spawn OKS_ArtyFire;
		...
		[Trigger_7,false,[0,0,false,false],east,3,2,0,[0,true,false,0],[0,false],[0,false],[0,0,0,0,0],false] spawn OKS_CreateZone;
