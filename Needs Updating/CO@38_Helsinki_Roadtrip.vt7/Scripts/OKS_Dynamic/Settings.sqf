...
Switch (_Faction) do {
	...
	case "SOVIET":{
		...
		_Wheeled = ["UK3CB_CW_SOV_O_EARLY_BRDM2_HQ", 
"UK3CB_CW_SOV_O_EARLY_VDV_UAZ_MG", 
"UK3CB_CW_SOV_O_EARLY_VDV_UAZ_Closed", 
"UK3CB_CW_SOV_O_EARLY_UAZ_Open","rhs_gaz66_msv","rhs_kamaz5350_msv"];
		_APC = ["rhs_btr60_msv","UK3CB_CW_SOV_O_EARLY_BRDM2","UK3CB_CW_SOV_O_EARLY_MTLB_KPVT"];
