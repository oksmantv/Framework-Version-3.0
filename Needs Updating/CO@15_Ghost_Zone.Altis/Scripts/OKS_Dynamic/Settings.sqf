...
Switch (_Faction) do {
	...
	case "TKA":
	{
		...
		_Wheeled = ["UK3CB_TKA_O_GAZ_Vodnik_Cannon","UK3CB_TKA_O_Hilux_Closed", "UK3CB_TKA_O_Hilux_Spg9", "UK3CB_TKA_O_Hilux_Zu23_Front", "UK3CB_TKA_O_UAZ_SPG9"];
		_APC = ["UK3CB_TKA_O_BMP1", "UK3CB_TKA_O_BMP2", "UK3CB_TKA_O_BTR80a"];
...
_ObjectiveTypes = ["cache","artillery","antiair"];
