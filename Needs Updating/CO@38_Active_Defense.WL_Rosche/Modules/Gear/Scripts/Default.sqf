...
switch (toLower(_role)) do {
	...
	case "sl": {
		...
		[["ACE_EntrenchingTool",1],[_rifleGL_mag,4]] call _addToBackpack;
		_rangefinder call _addBino;
		[_map, "", "", _compass, _watch, ""] call _addLinkedItems;
	...
	case "ftl": {
		...
		[["ACE_EntrenchingTool",1],[_rifleGL_mag,4],[_glHE,7],[_glSmokeR,5]] call _addToBackpack;
		_rangefinder call _addBino;
		[_map, "", "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
	...
	case "r": {
		...
		[["ACE_EntrenchingTool",1],[_grenade,2],[_rifle_mag,4],[_rifle_mag_tr,4]] call _addToVest;
	...
	case "g": {
		...
		[["ACE_EntrenchingTool",1],[_glHE,7],[_glsmokeR,3],[_glsmokeY,3],[_clacker,1],[_demoCharge,2],[_rifleGL_mag_tr,2]] call _addToBackpack;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
			[[_mapFlashLight,1],[_IRStrobe,1]] call _addToUniform;
	...
	case "ag": {
		...
		[["ACE_EntrenchingTool",1],[_LMG_mag,COUNT_AG_MAGS(_LMG_mag)],[_clacker,1],[_demoCharge,3]] call _addToBackpack;
	...
	case "ar": {
		...
		[["ACE_EntrenchingTool",1],[_LMG_mag,COUNT_AR_MAGS(_LMG_mag)]] call _addToBackpack;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
			[[_mapFlashLight,1],[_handFlareG,1]] call _addToUniform;
	...
	case "ab": {
		...
		[_rifleC, _rifleC_mag, ""] call _addPrimary;
		[_LAT, _LAT_mag, ""] call _addLaunchers;
		[[_cables,2],[_flashBang,2],[_rifleGL_mag_tr,6],[_pistol_mag,2],[_smokegrenadeY,3]] call _addToUniform;
		[[_grenade,2],[_rifleC_mag,3],[_rifleC_mag_tr,3],[_rifle_mag_tr,6]] call _addToVest;
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_rifle_mag_tr,4],[_LMG_mag_tr,3],[_MAT_Mag,2],[_glHE,5]] call _addToBackpack;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
			[[_mapFlashLight,1],[_handFlareG,1]] call _addToUniform;
	...
	case "mat": {
		...
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,2],[_pistol_mag,2],[_smokegrenadeY,3],[_defusalKit,1],[_clacker,1]] call _addToUniform;
		[[_cables,4],[_grenade,2],[_grenade,2],[_rifle_mag_tr,5],[_demoCharge,1]] call _addToVest;
	...
	case "amat": {
		...
		[[_rifle_mag_tr,6],[_glHE,6],[_glsmokeR,3],[_demoCharge,1],[_clacker,1]] call _addToVest;
		[[_HAT_mag,1]] call _addToBackpack;
		[_map, _gps, "", _compass, _watch, ""] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
			_nvg call _addNVG;
