...
_silencer = "JCA_muzzle_snds_556_tactical_olive";
...
_rifleL = ["JCA_arifle_M4A4_AFG_olive_F", _silencer, _pointer, _sight, _bipod];
...
_rifleL_mag = "JCA_30Rnd_556x45_Red_PMAG";
_rifleL_mag_tr = "JCA_30Rnd_556x45_Tracer_Red_PMAG";
