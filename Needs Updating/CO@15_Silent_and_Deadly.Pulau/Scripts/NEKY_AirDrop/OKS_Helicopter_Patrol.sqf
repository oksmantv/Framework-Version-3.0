...
waitUntil { sleep 10; {_Side knowsAbout _X > 3.985 && _X distance _Heli < _ReinforcementRange && isTouchingGround _X} count AllPlayers > 0};
SystemChat "Helicopter detected players..";
sleep 60;
waitUntil { sleep 10; {_Side knowsAbout _X > 3.985 && _X distance _Heli < _ReinforcementRange && isTouchingGround _X} count AllPlayers > 0};
SystemChat "Helicopters confirmed players. Deploying..";
