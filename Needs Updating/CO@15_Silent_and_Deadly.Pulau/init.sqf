...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
		...
		if(isServer) then {
			...
			//// START OF ZONE /////
			// [Trigger_1_1,false, [0, 20, false, false],east, 0, 0, 0] spawn OKS_CreateZone;
			// [Trigger_1_2,false, [0, 20, false, false],east, 0, 0, 0] spawn OKS_CreateZone;


			// [Trigger_2_1,false, [0, 20, false, false],east, 0, 0, 0] spawn OKS_CreateZone;
			// [Trigger_2_2,false, [0, 20, false, false],east, 0, 0, 0] spawn OKS_CreateZone;

			// [Trigger_3_1,false, [0, 20, false, false],east, 0, 0, 0] spawn OKS_CreateZone;
			// [Trigger_3_2,false, [0, 20, false, false],east, 0, 0, 0] spawn OKS_CreateZone;


			// [Trigger_4_1,false, [0, 20, false, false],east, 0, 0, 0] spawn OKS_CreateZone;
			// [Trigger_4_2,false, [0, 20, false, false],east, 0, 0, 0] spawn OKS_CreateZone;
				

			waitUntil{sleep 5; !(isNil "OKS_Helicopter_Patrol")};
			[east,"UK3CB_CW_SOV_O_LATE_Mi8AMT",helipad_1,1000,[1,0.5],1000,getMarkerPos "helicopter_despawn",true,false] execVM "Scripts\NEKY_AirDrop\OKS_Helicopter_Patrol.sqf";
			[east,"UK3CB_CW_SOV_O_LATE_Mi8AMT",helipad_2,1000,[1,0.5],1000,getMarkerPos "helicopter_despawn",true,false] execVM "Scripts\NEKY_AirDrop\OKS_Helicopter_Patrol.sqf";
			[east,"UK3CB_CW_SOV_O_LATE_Mi8AMT",helipad_3,1000,[1,0.5],1000,getMarkerPos "helicopter_despawn",true,false] execVM "Scripts\NEKY_AirDrop\OKS_Helicopter_Patrol.sqf";								
