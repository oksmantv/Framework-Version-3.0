...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
		...
		if(isServer) then {
			...
			//// END OF ZONE ////
			[east,"UK3CB_TKA_O_UH1H_M240",airpatrol_4,1000,[2,1],2000,getMarkerPos "egress",true,true] execVM "Scripts\NEKY_AirDrop\OKS_Helicopter_Patrol.sqf";
			[east,"UK3CB_TKA_O_Mi8",airpatrol_1,1000,[2,1],2000,getMarkerPos "egress",true,true] execVM "Scripts\NEKY_AirDrop\OKS_Helicopter_Patrol.sqf";
			[east,"UK3CB_TKA_O_UH1H_M240",airpatrol_2,1000,[2,1],2000,getMarkerPos "egress",true,true] execVM "Scripts\NEKY_AirDrop\OKS_Helicopter_Patrol.sqf";
			[east,"UK3CB_TKA_O_UH1H_GUNSHIP",airpatrol_3,1000,[2,1],2000,getMarkerPos "egress",true,true] execVM "Scripts\NEKY_AirDrop\OKS_Helicopter_Patrol.sqf";
			[east,"UK3CB_TKA_O_UH1H_M240",airpatrol_5,1000,[2,1],2000,getMarkerPos "egress",true,true] execVM "Scripts\NEKY_AirDrop\OKS_Helicopter_Patrol.sqf";
