...
_insignia = "";
_goggles = ["G_Balaclava_TI_G_blk_F","rhsusf_shemagh_gogg_od","rhsusf_shemagh2_gogg_od","rhsusf_oakley_goggles_blk","G_Balaclava_TI_G_blk_F","rhs_googles_black","rhsusf_oakley_goggles_clr"];
...
_backpack = ["B_Kitbag_cbr","B_AssaultPack_cbr"];
if (GVARMAIN(mod_TFAR)) then {
	_backpackRadio = ["tfw_ilbe_blade_coy","tfw_ilbe_dd_coy","tfw_ilbe_coy"];
};
...
_LMG = ["UK3CB_BAF_L110A3", "uk3cb_baf_silencer_l110", _pointer, _sight, ""];
