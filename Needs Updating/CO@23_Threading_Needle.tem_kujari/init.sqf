...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
		...
		if(isServer) then {
			...
			[Trigger_1,false,[12,0,true,false],independent,0,0,0,[0,true,false,0],[0,false],[0,false],[0,0,0,0,0],true] spawn OKS_CreateZone;
			[Trigger_2,false,[24,0,true,false],independent,0,0,0,[0,true,false,0],[0,false],[0,false],[0,0,0,0,0],true] spawn OKS_CreateZone;
			[Trigger_3,false,[0,35,false,false],independent,2,1,0,[2,false,false,0.6],[0,false],[4,false],[0,0,0,0,0],false] spawn OKS_CreateZone;
			[Trigger_4,false,[0,0,false,false],independent,0,0,0,[0,true,false,0],[0,false],[0,false],[1,2,0,0,0],false] spawn OKS_CreateZone;
			[Trigger_5,false,[0,0,false,false],independent,0,0,0,[0,true,false,0],[0,false],[0,false],[0,2,0,0,0],false] spawn OKS_CreateZone;
		};
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
			...
			if(isServer && GOL_OKS_AMBIENCE isEqualTo 1) then {
				...
				[independent,"middleeast"] spawn OKS_FaceSwap;
