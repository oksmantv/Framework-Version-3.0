...
Sleep 5;
	...
	if(GOL_NEKY_REINSERT isEqualTo 1) then {
		...
		if(!isNil "flag_independent_1" && OKS_FRIENDLY_SIDE isEqualTo independent) then {
			[flag_independent_1,30,NEKY_PARADROP_TRIGGER] execVM "Scripts\NEKY_PickUp\OKS_Reinsert.sqf";
		};
	};
...
Sleep 10;
if(isServer) then {
	 [[officer_1,officer_2,officer_3,officer_4,officer_5],Prisoner_Trigger,1000,east] execVM "Scripts\OKS_Ambience\OKS_HVT_MoraleHit_Intel.sqf";
};
...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
		...
		if(isServer) then {
			...
			//// START OF ZONE /////
			[	
				Trigger_8,  // Name of Trigger used as Spawn Area
				false, 		// DO NOT EDIT
				[
					0,      // Number of Static Infantry - Preferred Game Logic Location 'Outpost'"
					12,		// Number of Patrolling Infantry
			...
			//// START OF ZONE /////
			[	
				Trigger_9,  // Name of Trigger used as Spawn Area
				false, 		// DO NOT EDIT
				[
					0,      // Number of Static Infantry - Preferred Game Logic Location 'Outpost'"
...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
			...
			if(isServer && GOL_OKS_AMBIENCE isEqualTo 1) then {
				...
				[independent,"african"] spawn OKS_FaceSwap;
