...
_insignia = "111thID";
_goggles = ["G_Combat","UK3CB_G_KLR_Oli","UK3CB_G_Neck_Shemag_Tan","UK3CB_G_Tactical_Clear","rhsusf_shemagh_gogg_od","rhsusf_shemagh2_gogg_od","rhsusf_oakley_goggles_blk","rhsusf_oakley_goggles_clr","rhsusf_shemagh_od","rhsusf_shemagh2_od","G_Balaclava_TI_blk_F","G_Balaclava_TI_G_blk_F"];
_helmet = ["H_HelmetB_light","H_HelmetB_light_sand","H_HelmetB_light_grass","H_HelmetB_light_desert","H_HelmetSpecB_sand","H_HelmetSpecB_paint2"];
_OfficerHelmet = "H_Beret_02";
_uniform = ["U_B_CombatUniform_mcam","U_B_CombatUniform_mcam_tshirt","U_B_CombatUniform_mcam_vest","U_B_CombatUniform_mcam_worn"];
_vest = ["rhsusf_iotv_ocp_Grenadier","rhsusf_iotv_ocp_Rifleman","rhsusf_iotv_ocp_SAW","rhsusf_iotv_ocp_Squadleader","rhsusf_iotv_ocp_Teamleader"];
