...
switch (toLower(_role)) do {
	...
	case "pl": {
		...
		[[_rifle_mag_tr,5]] call _addToVest;
	...
	case "ftl": {
		...
		_IFAK call _addToUniform;
		[[_smokegrenadeW,2]] call _addToUniform;
	...
	case "lr": {
		...
		[[_rifleL_mag,7],[_rifleL_mag_tr,7]] call _addToVest;
		_IFAK call _addToUniform;
	...
	case "ab": {
		[_goggles,_helmet,_uniform,_vest,_backpack] call _addEquipment;
		[_rifleC, _rifleC_mag, ""] call _addPrimary;
		[[_rifleC_mag,7],[_rifleC_mag_tr,7]] call _addToVest;
		_IFAK call _addToUniform;
		[[_smokegrenadeW,3]] call _addToUniform;
		[_map, "", "ItemRadio", _compass, _watch, _nvg] call _addLinkedItems;
		if ((call EFUNC(Common,isNight)) && _allowedNightStuff) then {
	...
	case "p": {
		...
		_IFAK call _addToUniform;
		[[_smokegrenadeW,1],[_smokegrenadeP,1]] call _addToUniform;
	...
	case "marksman": {
		...
		_IFAK call _addToUniform;
		[[_rifleMarksman_mag,3],[_smokegrenadeW,6]] call _addToVest;
