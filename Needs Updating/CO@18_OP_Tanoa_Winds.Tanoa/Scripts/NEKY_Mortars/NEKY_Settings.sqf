...
_PreciseSize = [2,3,3];									// Randomly select number of mortars per "Precise" rotation.														Array of numbers (Mortars)
_PreciseReloadTime = 180;									// The time it takes for the mortar to prepare for another strike after performing a Precise strike.				Number (Seconds)
...
// Day/Night time
_Sunrise = 6.30;											// The time it gets bright enough for smokes to be used instead of flares.											Number (0.00 - 23.59)
