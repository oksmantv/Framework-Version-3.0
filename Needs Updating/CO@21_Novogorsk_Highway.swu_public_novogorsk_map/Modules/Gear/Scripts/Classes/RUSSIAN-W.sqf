...
if(_role == "sniper") then {
	_helmet = "";
	_backpack = "UK3CB_B_Bedroll_Backpack_GRN";
	_uniform = "UK3CB_CW_SOV_O_Late_U_Spetsnaz_Uniform_Gorka_01_KLMK";
	_vest = "rhs_6b23_digi_sniper";
	_goggles = "rhs_balaclava";
};
...
_silencer = "";
_pointer = "";
_sight = "rhs_acc_dh520x56";
_bipod = "";

_rifleMarksman = ["rhs_weap_t5000", _silencer, _pointer, _sight, _bipod];
_rifleMarksman_mag = "rhs_5Rnd_338lapua_t5000";