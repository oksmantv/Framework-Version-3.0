...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
			...
			if(isServer && GOL_OKS_AMBIENCE isEqualTo 1) then {
				...
				[west,"russian"] spawn OKS_FaceSwap;
			};
		/*
		*/

		[aa_1,west,false,2000,true] spawn GW_Ambient_AAA;
		[aa_2,west,false,2000,true] spawn GW_Ambient_AAA;
		[aa_3,west,false,2000,true] spawn GW_Ambient_AAA;
		[aa_4,west,false,2000,true] spawn GW_Ambient_AAA;
		[aa_5,west,false,2000,true] spawn GW_Ambient_AAA;
		[mortar_1, west, "precise", "light", ["auto", 50],200,1000,25] execVM "Scripts\NEKY_Mortars\NEKY_Mortars.sqf";
		[mortar_2, west, "precise", "light", ["auto", 50],200,1000,25] execVM "Scripts\NEKY_Mortars\NEKY_Mortars.sqf";
