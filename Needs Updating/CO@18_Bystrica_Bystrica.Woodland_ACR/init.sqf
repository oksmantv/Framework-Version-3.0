...
/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
		...
		*/
		...
		if(isServer && GOL_NEKY_HUNT isEqualTo 1) then {
			...
			[Hunt_1, HuntSpawn_1, NEKY_Hunt_Trigger_1, 5,300,east,["UK3CB_ARD_O_GAZ_Vodnik_KVPT", "UK3CB_ARD_O_GAZ_Vodnik_Cannon", "UK3CB_ARD_O_GAZ_Vodnik_PKT", "UK3CB_ARD_O_GAZ_Vodnik", "UK3CB_LSM_O_Gaz66_Open", "UK3CB_KDF_O_Gaz66_ZU23"],30] spawn NEKY_Hunt_HuntBase;
		};
