...
if(isServer) then {
	{[east,_X,getMarkerPos "respawn_west",5,300,60] execVM "Scripts\OKS_Ambience\OKS_ArtyFire.sqf"; sleep (5 + random 5)} foreach [arty_1,arty_2,arty_3,arty_4,arty_5];
};
