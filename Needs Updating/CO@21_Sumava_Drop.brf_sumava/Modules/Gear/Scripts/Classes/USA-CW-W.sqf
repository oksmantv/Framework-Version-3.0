...
_helmet = ["rhssaf_helmet_m97_woodland","rhssaf_helmet_m97_woodland_black_ess","rhssaf_helmet_m97_woodland_black_ess_bare"];
...
_rifleC = ["UK3CB_M16A3", _silencer, _pointer, _sight, _bipod];
...
_LMG = ["UK3CB_BAF_L110A1", "UK3CB_BAF_SFFH", _pointer, _sight, ""];
