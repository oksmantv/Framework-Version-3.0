...
laptop3 addAction ["<t color='#00FF00'>Show/Hide New Gunner Courses</t>", { [[],{ if(GunnerCourseShow == false) then {GunnerCourseShow=True} else {GunnerCourseShow=false}; }] remoteExec ["BIS_FNC_CALL",2] }, [], 10, false, false, "", "", 5];
