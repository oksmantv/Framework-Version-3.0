...
switch (_case) do {
	...
	case 11: {
		[Compound_Index_11,_ProcentageOfTargets] spawn _code;
	};					

	case 12: {
		[Compound_Index_12,_ProcentageOfTargets] spawn _code;
	};	

	case 13: {
		[Compound_Index_13,_ProcentageOfTargets] spawn _code;
	};	

	case 14: {
		[Compound_Index_14,_ProcentageOfTargets] spawn _code;
	};	

	case 15: {
		[Compound_Index_15,_ProcentageOfTargets] spawn _code;
	};		
