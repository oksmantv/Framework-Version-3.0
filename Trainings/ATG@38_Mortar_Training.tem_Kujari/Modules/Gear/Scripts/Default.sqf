...
switch (toLower(_role)) do {
	...
	case "lightdragon": {
		[_goggles,_helmet,_uniform,_vest,"acp_gol_GB_DDPM_B_Bergen_GB_DDPM_F"] call _addEquipment;
		[_rifleC, _rifleC_mag, ""] call _addPrimary;
		[_pistol, _pistol_mag, ""] call _addHandGun;
		_IFAK call _addToUniform;
		...
		[["UK3CB_BAF_1Rnd_60mm_Mo_Shells",4],["GOL_Packed_60mm_HEAB",4]] call _addToVest;
