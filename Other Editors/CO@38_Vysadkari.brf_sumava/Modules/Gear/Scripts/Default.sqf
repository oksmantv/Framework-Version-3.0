...
switch (toLower(_role)) do {
	...
	case "pl": {
		...
		[_pistol, _glHEDP, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_mapTools,1],[_HelmetCam,1],[_notepad,1],[_cables,6],[_gps,1],[_grenade,2],[_flashBang,2],[_pistol_mag,0],[_smokegrenadeY,4],[_smokegrenadeB,3],[_glsmokeR,5]] call _addToUniform;
	...
	case "fac": {
		[_goggles,_helmet,_uniform,_vest,_backpackRadio] call _addEquipment;
		[_rifleGL, _rifleGL_mag_tr] call _addPrimary;
		[_pistol, _glsmokeR, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_mapTools,1],[_HelmetCam,1],[_notepad,1],[_cables,6],[_gps,1],[_pistol_mag,0],[_grenade,2],[_smokegrenadeY,5]] call _addToUniform;
	...
	case "sl": {
		...
		[_pistol, _glHEDP, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_mapTools,1],[_HelmetCam,1],[_notepad,1],[_cables,6],[_gps,1],[_grenade,2],[_flashBang,2],[_pistol_mag,0],[_glsmokeR,5],[_smokegrenadeY,4],[_smokegrenadeB,3]] call _addToUniform;
		[[_grenade,2],[_rifleGL_mag_tr,5],[_glHEDP,7]] call _addToVest;
		[[_rifleGL_mag,4]] call _addToBackpack;
		_rangefinder call _addBino;
		[_map, "", "", _compass, _watch, ""] call _addLinkedItems;
	...
	case "ftl": {
		...
		[[_grenade,4],[_rifleGL_mag_tr,4],[_pistol_mag,0],[_smokegrenadeY,4]] call _addToVest;
	...
	case "r": {
		...
		[[_MAT_mag,3]] call _addToBackpack;
		if(_EntrenchAllow isEqualTo true) then {
			[[_entrenchingTool,1]] call _addToBackpack;
		};
	...
	case "g": {
		...
		[_pistol, _glHEDP, ""] call _addHandGun;
		_IFAK call _addToUniform;
		[[_cables,6],[_grenade,2],[_incendiaryGrenade,3],[_flashBang,3],[_pistol_mag,0],[_smokegrenadeY,3]] call _addToUniform;
