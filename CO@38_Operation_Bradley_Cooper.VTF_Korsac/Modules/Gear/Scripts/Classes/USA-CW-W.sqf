...
_helmet = ["UK3CB_CW_US_B_LATE_H_PASGT_01_WDL_GOL"];
...
_vest = ["UK3CB_CW_US_B_LATE_V_PASGT_Crew_Vest_GOL","UK3CB_CW_US_B_LATE_V_PASGT_MG_Vest_GOL","UK3CB_CW_US_B_LATE_V_PASGT_Rif_Vest_GOL"];
...
_LMG = ["GOL_weap_m249_pip", _silencer, _pointer, _sight, ""];
