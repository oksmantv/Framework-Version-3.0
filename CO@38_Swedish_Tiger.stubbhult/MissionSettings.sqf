...
/* AI Gear Settings */
// 0 = 0%, 1 = 100%
GOL_LAT_Chance = 0.65; // Chance for Light AT to be given to AI.
GOL_MAT_Chance = 0.55; // Chance for Medium AT to be given to AI.
GOL_UGL_Chance = 0.25; // Chance for UGL to be given to AI.

/* AI Static Settings */
// 0 = 0%, 1 = 100%
GOL_Static_Enable_Chance = 0.5; // Chance per loop to enable a Static AI to move.
