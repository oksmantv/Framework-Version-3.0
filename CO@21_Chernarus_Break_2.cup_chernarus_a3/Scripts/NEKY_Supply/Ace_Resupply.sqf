if (hasInterface) then {
	...
	_code =
	{
		...
		[Side Player, systemChat "Pilot: Awaiting coordinates"] onMapSingleClick
		{
			...
			{
				Case WEST: {_BoxCode = {[_Box, ["tiny_box","west"]] call GW_Gear_Fnc_Init; [_Box] ExecVM "Scripts\NEKY_ServiceStation\MobileSS.sqf";}};
				Case EAST: {_BoxCode = {[_Box, ["tiny_box","east"]] call GW_Gear_Fnc_Init; [_Box] ExecVM "Scripts\NEKY_ServiceStation\MobileSS.sqf"; }};
				Case INDEPENDENT: {_BoxCode = {[_Box, ["tiny_box","indep"]] call GW_Gear_Fnc_Init; [_Box] ExecVM "Scripts\NEKY_ServiceStation\MobileSS.sqf";}};
			};
